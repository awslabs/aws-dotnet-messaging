...
namespace AWS.Messaging
{
    ...
    public class SQSMetadata
    {
        ...
        /// <summary>
        /// The approximate timestamp the message was first received, based on the corresponding message attribute generated by SQS
        /// </summary>
        public DateTimeOffset ApproximateFirstReceiveTimestamp { get; set; }
