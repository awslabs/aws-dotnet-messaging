...
/// <summary>
/// Instances of <see cref="IMessagePoller" /> handle polling for messages from the underlying AWS service. Once
/// messages are received from the underlying service they are deserialized into <see cref="MessageEnvelope{T}"/>;
